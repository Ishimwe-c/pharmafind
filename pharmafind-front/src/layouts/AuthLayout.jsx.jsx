...
export default function AuthLayout() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      {/* Enhanced Header - Matching Landing Page Design */}
      ...
      {/* Main Auth Content - Enhanced Design */}
      <main className="flex-grow flex items-center justify-center px-4 py-12 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="w-full max-w-4xl bg-white shadow-xl rounded-2xl p-8 border border-gray-100">
          <Outlet /> {/* all auth child pages render here */}
        </div>
      </main>
      <Footer />
    </div>
